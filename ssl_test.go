...
func TestSSLList(t *testing.T) {
	...
	got, err := c.SSL.List(context.Background(), &ListOptions{Page: 1, PerPage: 20, OrderField: "id", OrderDirect: "desc"})
	if err != nil {
		t.Fatalf("List: %v", err)
	}
	if gotMethod != "index" {
...
func TestSSLListEmpty(t *testing.T) {
	...
	got, err := c.SSL.List(context.Background(), nil)
	if err != nil {
		t.Fatalf("List: %v", err)
	}
	if got != nil {
...
func TestSSLOrderList(t *testing.T) {
	...
	got, err := c.SSL.OrderList(context.Background())
	if err != nil {
...
func TestSSLDownload(t *testing.T) {
	...
	got, err := c.SSL.Download(context.Background(), 348533, "secret")
	if err != nil {
...
func TestSSLProlongInfo(t *testing.T) {
	...
	got, err := c.SSL.ProlongInfo(context.Background(), 348533)
	if err != nil {
...
func TestSSLProlongInfoEmpty(t *testing.T) {
	...
	got, err := c.SSL.ProlongInfo(context.Background(), 1)
	if err != nil {
		t.Fatalf("ProlongInfo: %v", err)
	}
	if got != nil {
...
func TestSSLEditAutoprolong(t *testing.T) {
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			raw, err := c.SSL.EditAutoprolong(context.Background(), 348533, tc.enabled)
			if err != nil {
...
func TestSSLRemoveCertificate(t *testing.T) {
	...
	raw, err := c.SSL.RemoveCertificate(context.Background(), 348533)
	if err != nil {
...
func TestSSLOrderSubmit(t *testing.T) {
	...
	raw, err := c.SSL.OrderSubmit(context.Background(), "test.ru", 348533, "admin@test.ru", &OrderSubmitOptions{
		PersonID:    360129,
		Autoprolong: true,
	})
	if err != nil {
...
func TestSSLOrderSubmitDefaults(t *testing.T) {
	...
	if _, err := c.SSL.OrderSubmit(context.Background(), "test.ru", 12, "admin@test.ru", nil); err != nil {
		t.Fatalf("OrderSubmit: %v", err)
	}
