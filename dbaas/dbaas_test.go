...
func TestDBaaSList(t *testing.T) {
	...
	idx, err := s.List(context.Background())
	if err != nil {
		t.Fatalf("List: %v", err)
	}
	if gotMethod != "index" {
...
func TestDBaaSSetUpgradeAgree(t *testing.T) {
	...
	if err := s.SetUpgradeAgree(context.Background(), true); err != nil {
...
func TestDBaaSSetUpgradeAgreeFailure(t *testing.T) {
	...
	if err := s.SetUpgradeAgree(context.Background(), false); err == nil {
...
func TestDBaaSConstructorPlanID(t *testing.T) {
	...
	id, err := s.ConstructorPlanID(context.Background(), 1, 2, 160, 1)
	if err != nil {
...
func TestDBaaSCreateInstance(t *testing.T) {
	...
	raw, err := s.CreateInstance(context.Background(), CreateInstanceRequest{
		EngineType:    "PostgreSQL",
		EngineVersion: "13",
		Users:         []UserCredentials{{Name: "test1", Password: "Pass_ByTest1"}},
		PlanID:        3,
...
func TestDBaaSEditInstance(t *testing.T) {
	...
	if err := s.EditInstance(context.Background(), EditInstanceRequest{
...
func TestDBaaSEditInstanceFailure(t *testing.T) {
	...
	if err := s.EditInstance(context.Background(), EditInstanceRequest{BillingID: "x"}); err == nil {
...
func TestDBaaSRemoveInstance(t *testing.T) {
	...
	raw, err := s.RemoveInstance(context.Background(), "testuser_dbaas_1")
	if err != nil {
...
func TestDBaaSDeleteDatabase(t *testing.T) {
	...
	raw, err := s.DeleteDatabase(context.Background(), "testuser_dbaas_1", "test1")
	if err != nil {
...
func TestDBaaSValidateUsers(t *testing.T) {
	...
	if err := s.ValidateUsers(context.Background(), []UserCredentials{{Name: "test1", Password: "Pass_ByTest1"}}); err != nil {
...
// serve spins up a mock JSON-RPC server for h and returns a dbaas.Service backed
